...
import { instrumentFastify } from '@sentry/server-utils';
 ...
 * ```
 */
export declare const fastifyIntegration: (options?: Partial<FastifyIntegrationOptions> | undefined) => Integration & {
    name: string;
};
/**
