...
const CustomersApiAxiosParamCreator = function (cashfree) {
    return {
        ...
        pGCreateCustomer: (x_api_version_1, CreateCustomerRequest_1, x_request_id_1, x_idempotency_key_1, ...args_1) => __awaiter(this, [x_api_version_1, CreateCustomerRequest_1, x_request_id_1, x_idempotency_key_1, ...args_1], void 0, function* (x_api_version, CreateCustomerRequest, x_request_id, x_idempotency_key, options = {}) {
            ...
            yield setApiKeyToObject(localVarHeaderParameter, "x-partner-apikey", cashfree.XClientId, cashfree.XClientSecret, cashfree.XPartnerKey, cashfree.XPartnerMerchantId, cashfree.XClientSignature);
            // authentication XClientSecret required
            yield setApiKeyToObject(localVarHeaderParameter, "x-client-secret", cashfree.XClientId, cashfree.XClientSecret, cashfree.XPartnerKey, cashfree.XPartnerMerchantId, cashfree.XClientSignature);
            // authentication XPartnerMerchantID required
            yield setApiKeyToObject(localVarHeaderParameter, "x-partner-merchantid", cashfree.XClientId, cashfree.XClientSecret, cashfree.XPartnerKey, cashfree.XPartnerMerchantId, cashfree.XClientSignature);
            // authentication XClientID required
            yield setApiKeyToObject(localVarHeaderParameter, "x-client-id", cashfree.XClientId, cashfree.XClientSecret, cashfree.XPartnerKey, cashfree.XPartnerMerchantId, cashfree.XClientSignature);
            // authentication XClientSignatureHeader required
            yield setApiKeyToObject(localVarHeaderParameter, "x-client-signature", cashfree.XClientId, cashfree.XClientSecret, cashfree.XPartnerKey, cashfree.XPartnerMerchantId, cashfree.XClientSignature);
